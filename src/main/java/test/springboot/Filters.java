 ...
 * 
 * @Configuration public class Filters {
 * 
 * @Bean public FilterRegistrationBean loginRegistrationBean() {
 ...
 * 
 * @Bean public FilterRegistrationBean restRegistrationBean() {
 * System.out.println("Setting up restRegistrationBean"); FilterRegistrationBean
