/*
 * package test.springboot; import java.io.IOException; import
 * java.util.Optional; import javax.servlet.Filter; import
 ...
 * 
 * @Component public class RestFilter implements Filter {
 * 
 ...
 * 
 * 
 * Optional<String> userFromToken = getUserFromToken(request); if
 * (!userFromToken.isPresent()) {
